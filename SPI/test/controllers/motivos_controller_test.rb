...
class MotivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create motivo" do
    assert_difference('Motivo.count') do
      post motivos_url, params: { motivo: { id_motivo: @motivo.id_motivo, tipo_motivo: @motivo.tipo_motivo } }
    end
  ...
  test "should update motivo" do
    patch motivo_url(@motivo), params: { motivo: { id_motivo: @motivo.id_motivo, tipo_motivo: @motivo.tipo_motivo } }
