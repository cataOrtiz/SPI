...
class RespuestaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create respuestum" do
    assert_difference('Respuestum.count') do
      post respuesta_url, params: { respuestum: { encuestum_id: @respuestum.encuestum_id, preguntum_id: @respuestum.preguntum_id, valor_pregunta: @respuestum.valor_pregunta } }
    end
  ...
  test "should update respuestum" do
    patch respuestum_url(@respuestum), params: { respuestum: { encuestum_id: @respuestum.encuestum_id, preguntum_id: @respuestum.preguntum_id, valor_pregunta: @respuestum.valor_pregunta } }
